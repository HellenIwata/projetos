...
class Relatorios():
    ...
    def gera_relatorio_cliente(self):
        ...
        #Condição responsável por verificar se o campo 'code_rel' está vazio e impedir a criação do relatório
        if self.code_rel:
            self.variaveis_get()
            ...
            showerror("Erro", "Não foi selecionado nenhum cliente")
